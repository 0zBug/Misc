...
function switch(name, path, default)
    ...
    RightButton1.MouseButton1Down:Connect(function()
        if one1 == false then
           ...
           local Tween = game:GetService("TweenService"):Create(Selection2,TweenInfo.new(0.2),{TextTransparency=1})
           Tween:Play()
           wait()
           loadstring(path.." = true")()
           Selection1.Position = UDim2.new(-0.05, 0, 0, 0)
           Selection1.Visible = true
           local Tween = game:GetService("TweenService"):Create(Selection1,TweenInfo.new(0.2),{TextTransparency=0})
           Tween:Play()
           ...
           Selection1:TweenPosition(UDim2.new(0.25, 0, 0, 0), "Out", "Sine", 0.2)
           local Tween = game:GetService("TweenService"):Create(Selection1,TweenInfo.new(0.2),{TextTransparency=1})
           Tween:Play()
           wait()
           loadstring(path.." = false")()
           Selection2.Position = UDim2.new(-0.05, 0, 0, 0)
           Selection2.Visible = true
           local Tween = game:GetService("TweenService"):Create(Selection2,TweenInfo.new(0.2),{TextTransparency=0})
           Tween:Play()
    ...
    LeftButton1.MouseButton1Down:Connect(function()
        if one2 == false then
           Selection1:TweenPosition(UDim2.new(-0.05, 0, 0, 0), "Out", "Sine", 0.2)
           local Tween = game:GetService("TweenService"):Create(Selection1,TweenInfo.new(0.2),{TextTransparency=1})
           Tween:Play()
           wait()
           loadstring(path.." = false")()
           Selection2.Position = UDim2.new(0.25, 0, 0, 0)
           Selection2.Visible = true
           local Tween = game:GetService("TweenService"):Create(Selection2,TweenInfo.new(0.2),{TextTransparency=0})
           Tween:Play()
           Selection2:TweenPosition(UDim2.new(0.1, 0, 0, 0), "Out", "Sine", 0.2)
           ...
           Selection2:TweenPosition(UDim2.new(-0.05, 0, 0, 0), "Out", "Sine", 0.2)
           local Tween = game:GetService("TweenService"):Create(Selection2,TweenInfo.new(0.2),{TextTransparency=1})
           Tween:Play()
           wait()
           loadstring(path.." = true")()
           Selection1.Position = UDim2.new(0.25, 0, 0, 0)
           Selection1.Visible = true
           local Tween = game:GetService("TweenService"):Create(Selection1,TweenInfo.new(0.2),{TextTransparency=0})
           Tween:Play()
           Selection1:TweenPosition(UDim2.new(0.1, 0, 0, 0), "Out", "Sine", 0.2)
