return {
	...
	(number, number, number, number) -> Rect = "Returns a new Rect using the first and last two arguments as coordinates for corners",
	...
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	Built-in Function Color = "Sets the color of built-in functions and keywords in the script editor",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	(number, number, number) -> NumberSequenceKeypoint = "Returns a keypoint with the specified time, value, and envelope",
...
It's supposed to render a large XYZ axis in the center of the world, but the axis rendering component doesn't work correctly",
	...
	() -> number = "Returns a pseudorandom number uniformly distributed over [0, 1)",
...
<p class="text-nowrap" style={{fontFamily: 'Creepster', fontSize: '1.75em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	() -> UDim2 = "Returns a UDim2 with two zero <code>datatype.UDim</code",
...
This gets fired periodically in Roblox Studio when a session starts.",
	...
	Text Wrapping = "If set to true, text in the script editor will be wrapped",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Show Navigation Mesh = "When set to true, the navigation mesh used by the <code>PathfindingService</code> will be visualized",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
...
To set the color of a material, use: <code>Terrain:SetMaterialColor</code",
	...
	Basic Objects Display Mode = "Sets the scrolling mode of the <i>Advanced Objects</i> tab in Roblox Studio",
...
This should point to a clone of <a rel="nofollow" class="external text" href="https://github.com/ROBLOX/Core-Scripts">Roblox's CoreScript GitHub repository</a>",
	...
	(number) -> BrickColor = "Constructs a BrickColor from its numerical index",
	...
	Tab Width = "Specifies how many spaces are used to represent a tab in the script editor",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	...
	Warning Color = "Specifies the color of the wavy underline shown when the script analyzer picks up a problem that should be addressed in the script editor",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	...
	Keyword Color = "Sets the text color of built-in Lua keywords",
	...
	(number, number) -> NumberRange = "Returns a NumberRange with the provided minimum and maximum",
...
<p class="text-nowrap" style={{fontFamily: 'Roboto Mono', fontSize: '1.45em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	Drag Multiple Parts As Single Part = "If set to true, the bounding box of a selection will be used for collision detection while dragging, instead of each individual part being checked.
This makes the dragger perform smoother, but with notably less precision",
	...
	Text Color = "Specifies the color of normal text in the script editor",
...
Should be parented to <code>ReflectionMetadataClasses</code",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	(number) -> NumberRange = "Returns a NumberRange with the provided value as both the minimum and the maximum",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	...
	Clear Output On Start = "If set to true, the output will be automatically cleared when game sessions are switched",
...
![<a href="/assets/blt4aaa5534850ad583/GearType_Ranged.png">Ranged Attribute</a",
	...
	(number, number, number, number) -> UDim2 = "Returns a UDim2 from the given components",
	...
	(number, number, number, number, number) -> PhysicalProperties = "Returns a PhysicalProperties with the specified values",
	...
	(Vector3, Vector3) -> CFrame = "Returns a CFrame with the position of the first Vector3 and an orientation pointed toward the second",
	...
	() -> Rect = "Returns a new Rect with zero <code>Vector2</code>s",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	...
	(number, number, number) -> CFrame = "Returns a CFrame with a position comprised of the x, y, and z components provided",
	...
	(number, number) -> NumberSequenceKeypoint = "Returns a keypoint with the specified time and value",
	...
	(Color3) -> ColorSequence = "Returns a new ColorSequence that is entirely the specified color",
	...
	Select Color = "The color of the selection box used with object selections in the <code>Workspace</code",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	(table) -> NumberSequence = "Returns a NumberSequence from the given array of <code>datatype.NumberSequenceKeypoint</code>s",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as functions under the class this is parented to",
	...
	Selection Background Color = "Sets the background color of selected text in the script editor",
...
Defaults to 32 MBs.",
	...
	Show Diagnostics Bar = "If set to true, basic diagnostic information is shown in the bottom right",
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as events under the class this is parented to",
	...
	Enable Autocomplete = "When set to true, the script editor and command bar will show an autocomplete menu while writing",
...
<p class="text-nowrap" style={{fontFamily: 'Source Sans Pro', fontSize: '1.7em', fontWeight: 600, margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	(number, number, number, number, number, number, number, number, number, number, number, number) -> CFrame = "Creates a CFrame from position (x, y, z) with an orientation specified by the rotation matrix",
	...
	(table, number, Variant) -> () = "Inserts the provided value to the target position of the array",
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as properties under the class this is parented to",
	...
	(table, Variant) -> () = "Appends the provided value to the end of the array",
	...
	World Pivot Position = "Editor-only property to set the position of the pivot. Scripts must use <code>Model.WorldPivot</code> instead",
	...
	Maximum Output Lines = "The maximum number of lines that can be displayed in the output",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	...
	(Vector2, Vector2) -> Rect = "Returns a new Rect from the given <code>Vector2</code>s",
...
See <code>Enum.PermissionLevelShown</code> for more info",
	...
	(function, string) -> Tuple = "This method traverses the entire stack of current thread and returns a string containing the call stack of target function detail",
	...
	Camera Speed = "Sets the speed in studs/sec that the camera moves when movement keys are pressed",
	CollisionGroup = "The CollisionGroup used for the operation",
	...
	Pivot Offset Position = "Editor-only property to set the position of the pivot relative to a part. Scripts must use <code>BasePart.PivotOffset</code> instead",
...
<img alt="Navigation Attribute" src="/assets/bltb4bbcb97611d3ab5/GearType_Navigation.png" /",
	...
	Show Core GUI in Explorer while Playing = "If set to true, the <code>CoreGui</code> will be visible in the Explorer while the game is running",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	...
	Line Thickness = "Sets the thickness of the <code>Model.PrimaryPart</code> selection adornee.
This value is constrained between 0 and 0.0",
...
<p class="text-nowrap" style={{fontFamily: 'Source Sans Pro', fontSize: '1.7em', margin: '5px 0px'}}><i>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =</i",
	...
	Output Font = "Specifies the font used by the output",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Respect Studio shortcuts when game has focus = "When set to true, Roblox Studio shortcuts will take priority over inputs being captured in the game window",
	...
	Number Color = "Specifies the color of numbers in Roblox Studio's script editor",
...
starts",
	...
	Output Layout Mode = "Sets the layout mode of the output",
	Size24 = "Font size 24",
...
<img alt="Voxel" src="/assets/blt87d45df6d6aacbdc/Technology.Voxel.jpg" /",
	...
	(number, number, number, number, number, number, number) -> CFrame = "Returns a CFrame from position (x, y, z) and quaternion (qX, qY, qZ, qW)",
	...
	(thread, number, string) -> Tuple = "This method traverses the entire stack of target thread and returns a string containing the call stack of target level detail",
	...
	Hover Animate Speed = "Specifies how frequently the hover animation flashes when the mouse is hovering over a selectable object in the <code>Workspace</code>",
...
It's supposed to render a large XYZ axis in the center of each <code>BasePart</code>, but the axis rendering component doesn't work correctly",
	...
	Material) -> PhysicalProperties = "Returns a PhysicalProperties with the default properties for the given material",
	...
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	(number, number, number) -> PhysicalProperties = "Returns a PhysicalProperties with the specified density, friction, and elasticity",
	...
	Selection Color = "Sets the text color of selected text in the script editor",
...
<p class="text-nowrap" style={{fontFamily: 'Denk One', fontSize: '1.7em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	String Color = "Specifies the color of strings in the script editor",
	...
	Server Audio Behavior = "An unused Roblox Studio setting that does not appear to have any functionality",
...
<img alt="AlphaMode Transparency" src="/assets/bltd194e7f5a88d1fdd/fern-overlay.png" /",
	...
	Render Throttle Percentage = "Scales how much rendering will be throttled when the game window isn't being focused on.
...
<img alt="The Static TextureMode" src="/assets/blt4e6854cd4a39d272/Enum_TextureMode_Static.gif" /",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	(string?, number?) -> string = "Returns a string of undefined format that describes the current function call stack",
...
<div><div><div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><pre class="prettyprint linenums lang-lua">LocalizationTable:RemoveEntry(key,"","")</pre></div></div></div",
	...
	Comment Color = "Specifies the color of comments in Roblox Studio's script editor",
	...
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	Origin Position = "Editor-only property used to move the object. Scripts must use <code>PVInstance:PivotTo</code> instead",
...
Note: this property is set up automatically by the FBX importe",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	(Color3) -> BrickColor = "Constructs the closest BrickColor that can be matched to the specified Color3",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	...
	World Pivot Orientation = "Editor-only property to set the orientation of the pivot. Scripts must use <code>Model.WorldPivot</code> instead",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
...
<p class="text-nowrap" style={{fontFamily: 'Michroma', fontSize: '1.3em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	(number, number) -> number = "Returns a pseudorandom number uniformly distributed over [min, max)",
	...
	(table) -> ColorSequence = "Returns a new ColorSequence comprised of the provided ColorSequenceKeypoints",
...
If set to <a href="/articles/String" title="String"><span>"Client"</span></a>, this member will not be available to auto fill when editing a `Script`.",
	...
	Show Plugin GUI Service in Explorer = "When set to true, the <code>PluginGuiService</code> will be shown in Roblox Studio's explorer",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	GetServerTimeNow = "Returns the server epoch time in seconds",
	(number, number, number) -> BrickColor = "Constructs the closest BrickColor that can be matched to the specified RGB components",
...
If this is called inside of a script running inside of the TestService, this will initiate a <a href="/articles/Lua-debugger" class="mw-redirect" title="Lua Debugger">breakpoint</a> on the line that invoked the error.",
	...
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	(UDim, UDim) -> UDim2 = "Returns a UDim2 from the given <code>datatype.UDim</code>s",
...
Note: this property is set up automatically by the FBX importe",
	...
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	Orbital = "The camera has a fixed Y position, but can be rotated around the player",
	UI Theme = "Specifies the color scheme of Roblox Studio",
	...
	Show QT warnings in output = "If set to true, certain internal error messages regarding the QT framework that Roblox uses will be shown in the output",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	...
	Show Hover Over = "If set to true, hovering over an object in the <code>Workspace</code> will show a selection box",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Operator Color = "Sets the text color of operator characters in the script editor",
	Only Play Audio from Window in Focus = "If set to true, audio being played will only be heard if the game window is being focused on",
	Changed = "Fired whenever the <code>DoubleConstrainedValue.Value</code> of the <code>DoubleConstrainedValue</code> is change",
	Matching Word Background Color = "Sets the highlight color of double-clicked variables in the script editor",
	...
	MeshID = "The <strong>MeshId</strong> is the content ID of the mesh that is to be displayed on the <code>MeshPart</code",
	Hover Over Color = "Specifies the color that the hover selection box uses",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	PreferredPlayersInternal = "<code>Players.PreferredPlayers</code> for internal use",
	Find Selection Background Color = "Sets the highlight color of matches in the script editor's Find Selection operation (Ctrl+F)",
...
<p class="text-nowrap" style={{fontFamily: 'Luckiest Guy', fontSize: '1.6em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	Scriptable = "The player will not respond to default controls; any character movement must be defined in custom scripts",
	Animate Hover Over = "If set to true, the hover selection box that is shown when mousing over selectable objects in the <code>Workspace</code> will flash between <code>Studio/Hover Over Color</code> and <code>Studio/Select Color</code> based on the <code>Studio/Hover Animate Speed</code>",
...
<p class="text-nowrap" style={{fontFamily: 'Sarpanch', fontSize: '1.65em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	(number, string) -> Tuple = "This method traverses the entire stack of current thread and returns a string containing the call stack of target level detail",
...
<img alt="ShadowMap" src="/assets/blt5d79df0c0af20ab8/Technology.ShadowMap.jpg" /",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Error Color = "Specifies the color of the wavy underline shown when malformed code is detected in the script editor",
	...
	(thread, string?, number?) -> string = "Returns a string of undefined format that describes the current function call stack",
...
<p class="text-nowrap" style={{fontFamily: 'Source Sans Pro', fontSize: '1.7em', fontWeight: 300, margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	Origin Orientation = "Editor-only property used to rotate the object around its pivot. Scripts must use <code>PVInstance:PivotTo</code> instead",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	(Color3, Color3) -> ColorSequence = "Returns a new ColorSequence with <code>c0</code> as the start value and <code>c1</code> as the end value",
...
<img alt="Power Up Attribute" src="/assets/blt0c97538d414a753b/GearType_PowerUp.png" /",
	Always Save Script Changes = "If set to true, Roblox Studio will attempt to transfer script changes that were made during a Play Solo session to the opened place",
...
<img alt="AlphaMode OverLay" src="/assets/blt625b6777e66ae841/fern-cutout.png" /",
	...
	(Vector3) -> CFrame = "Returns a CFrame with no rotation with the position of the provided Vector3",
...
<img alt="Musical Attribute" src="/assets/bltfc24574f48eb2125/GearType_Musical.png" /",
	...
	(number) -> NumberSequence = "Returns a NumberSequence with the provided value as the start and end value",
...
<p class="text-nowrap" style={{fontFamily: 'Josefin Sans', fontSize: '1.75em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	Background Color = "Specifies the background color of Roblox Studio's script editor",
...
This is the only guaranteed way to verify if the user is on a console or not.",
	...
	Camera Shift Speed = "Sets the speed in studs/sec that the camera moves while holding down Shift with the movement keys",
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
...
<p class="text-nowrap" style={{fontFamily: 'Kalam', fontSize: '1.75em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + ",
	...
	Pivot Offset Orientation = "Editor-only property to set the orientation of the pivot relative to a part. Scripts must use <code>BasePart.PivotOffset</code> instead",
	Rect = "A value that represents a two-dimensional rectangle",
	...
	Camera Mouse Wheel Speed = "Sets how many studs the camera will move forward or backwards when using the mouse wheel",
	...
	(string) -> BrickColor = "Constructs a BrickColor from its name",
	...
	Wait = "Yields the current thread until the signal is fired and returns the parameters provided by the signal",
	MaxForce = "Determines the limit on how much force that may be applied to each axi",
	LoadCharacterLayeredClothing  = "Determines if the experience loads Layered Clothing accessories",
	Faces = "A datatype containing six booleans, each representing a face of a <code>BasePart</code>",
...
<code>BasePart</code> <em>ParamA</em> will determine the maximum speed at which the part will spin, and BasePart <em>ParamB</em> will determine how frequently it changes direction",
	...
	() -> CFrame = "Returns a blank identity CFrame",
...
<img alt="Transport Attribute" src="/assets/blt669c2a184782cd46/GearType_Transport.png" /",
	...
	Connect = "Connects the given function to the event and returns an RBXScriptConnection that represents it",
	(number, number) -> NumberSequence = "Returns a NumberSequence with the provided start and end values",
