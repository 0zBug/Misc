return {
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	walkanimation = [==[When this description is <code>Humanoid:ApplyDescription</code> to a <code>Humanoid</code>, this determines the <code>Animation.AnimationId</code> to play when its <code>Humanoid:GetState</code> is <code>enum.HumanoidStateType</code> at a low speed]==],
	octave = [==[The percentage to shift the original pitch.]==],
	itemchanged = [==[Fires when a property of any object in the <code>DataModel</code> is changed]==],
	...
	themechanged = [==[Event called when Studio's <code>StudioTheme</code> changes]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	low = [==[Low priority]==],
	maxpromptsvisible = [==[The maximum number of <code>ProximityPrompt</code> that will be shown to the user]==],
	...
	textwrapped = [==[Determines if text wraps to multiple lines within the <code>GuiObject</code> element space, truncating excess text]==],
...
GuiService:AddSelectionTuple(&quot;InventoryButtons&quot;, unpack(inventoryButtons))
	...
	distancelowerlimit = [==[Determines the distance in studs that a <code>BillboardGui</code> will stop scaling larger in size at]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	datacomplexitylimit = [==[The maximum amount of data that can be stored to a <code>Player</code> cache per place]==],
...
It's supposed to render a large XYZ axis in the center of the world, but the axis rendering component doesn't work correctly.]==],
	...
	selectable = [==[Determine whether the <code>GuiObject</code> can be selected by a gamepad]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	hairaccessory = [==[A comma-separated list of asset IDs that will be added as <code>Accessory</code> to a <code>Humanoid</code> rig when <code>Humanoid:ApplyDescription</code>, usually those attached to its head resembling hair]==],
	...
	didloop = [==[Fires whenever the <code>VideoFrame.Video</code> loops]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	proximitypromptservice = [==[Allows developers to interact with <code>ProximityPrompt</code> objects in a global way]==],
	...
	searchcatalog = [==[Returns a <code>CatalogPages</code> object containing the result of the given search]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	awardpoints = [==[Attempts to award the user with the specified <code>Player.UserId</code> the specified number of points]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	getmousebuttonspressed = [==[Returns an array of <code>InputObject</code> corresponding with the  mouse buttons currently being held down]==],
	image = [==[The asset is an image.]==],
	firstpersontransition = [==[Fires when the local user’s <code>Camera</code> switches in and out of first person mode]==],
...
<p class="text-nowrap" style={{fontFamily: 'Creepster', fontSize: '1.75em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	inspectplayerfromhumanoiddescription = [==[Allows a developer to bring up the Inspect menu showing the assets listed in this <code>HumanoidDescription</code> object]==],
	location = [==[Determines the relative position where the <code>BodyThrust.Force</code> is exerted]==],
	...
	getconnectedgamepads = [==[Returns an array of <code>Enum.UserInputType</code> gamepads currently connected]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	hataccessory = [==[A comma-separated list of asset IDs that will be added as <code>Accessory</code> to a <code>Humanoid</code> rig when <code>Humanoid:ApplyDescription</code>, usually those attached to its head]==],
	dismount = [==[The Dismount button]==],
	promptshown = [==[Triggers when the <code>ProximityPrompt</code> becomes visible]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	interpolate = [==[Tweens the <code>Camera</code> in a linear fashion towards a new <code>Camera.CFrame</code> and <code>Camera.Focus</code> over a given duration]==],
	...
	depthscale = [==[Determines by what factor the depth (back-to-front distance) of a Humanoid rig is scaled; when <code>Humanoid:ApplyDescription</code>, maps to the "DepthScale" <code>NumberValue</code> within the Humanoid]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	equippedemoteschanged = [==[Fires when the equipped emotes are <code>HumanoidDescription:SetEquippedEmotes</code> on this description]==],
	...
	anchorpoint = [==[Determines the origin point of a <code>GuiObject</code>, relative to its absolute size]==],
	...
	getinventory = [==[Returns an <code>InventoryPages</code> object with information about owned items in the users inventory with the given AvatarAssetTypes]==],
	...
	setroll = [==[Sets the current rotation applied around the <code>Camera</code> Z-axis]==],
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as yielding functions under the class this is parented to.]==],
	...
	cansendgameinviteasync = [==[Indicates whether the given <code>Player</code> can invite other players]==],
...
This gets fired periodically in Roblox Studio when a session starts.
	...
	promptsetfavoritecompleted = [==[Prompts the <code>LocalPlayer</code> to favorite or unfavorite the given asset or bundle]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	bundletype = [==[An array containing <code>enum.BundleType</code> values to filter the search by.]==],
	part0 = [==[The second <code>BasePart</code> that the constraint connects]==],
	...
	promptsaveavatar = [==[Prompts the <code>Players.LocalPlayer</code> to update their avatar based on the given <code>HumanoidDescription</code> and <code>Enum.RigType</code> of R6 or R15]==],
...
To set the color of a material, use: <code>Terrain:SetMaterialColor</code>]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	loadboolean = [==[Returns a boolean value that was previously saved to the player with <code>Player:SaveBoolean</code> with the same key]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	color3 = [==[Determines the colorization to be applied to the <code>Clothing</code> texture]==],
...
This should point to a clone of <a rel="nofollow" class="external text" href="https://github.com/ROBLOX/Core-Scripts">Roblox's CoreScript GitHub repository</a>.]==],
	...
	currentdistance = [==[The current distance in studs that the <code>BillboardGui</code> is from the player's camera]==],
	fail = [==[Indicates the progression failed]==],
	createbutton = [==[Creates <code>PluginToolbarButton</code> that allows the user to initiate a single, one-off action in Roblox Studio through the <code>PluginToolbarButton.Click</code> event]==],
	exp = [==[Returns the value e^x.]==],
	fontsize = [==[Determines the font size of a <code>TextBox</code> object]==],
	getobjects = [==[Returns an array of <code>Instance</code> associated with the given <code>Articles.Content</code> URL]==],
	...
	healthchanged = [==[Fires when the <code>Humanoid.Health</code> changes]==],
	...
	touchpinch = [==[Fired when a user pinches their fingers on a <code>UserInputService.TouchEnabled</code> device - such as the screen of a mobile device]==],
	...
	reserveserver = [==[Returns an access code that can be used to teleport players to a reserved server, along with the <code>DataModel.PrivateServerId</code> for it]==],
	...
	usejumppower = [==[Determines whether the <code>StarterPlayer.CharacterJumpHeight</code> (false) or <code>StarterPlayer.CharacterJumpPower</code> (true) property is used]==],
	...
	promptallowinventoryreadaccesscompleted = [==[Fires when the <code>AvatarEditorService:PromptAllowInventoryReadAccess</code> prompt is responded to by the user]==],
	...
	motor = [==[Makes a movable <code>JointInstance</code> between two parts]==],
...
<p class="text-nowrap" style={{fontFamily: 'Roboto Mono', fontSize: '1.45em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	touchtap = [==[Fired when a user taps their finger on a <code>UserInputService.TouchEnabled</code> device - such as the screen of a mobile device]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	requireslineofsight = [==[Whether the prompt is hidden if the path between the player’s <code>Camera</code> and object parented to the <code>ProximityPrompt</code> is obstructed]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	loadinstance = [==[Returns an instance that was previously saved to the player with <code>Player:SaveInstance</code> with the same key]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	theme = [==[Used to get/set current <code>StudioTheme</code> used by Studio]==],
	udim2 = [==[A two-dimensional value where each dimension is composed of a relative scale and an absolute offset.]==],
	...
	getgameplaypausednotificationenabled = [==[Returns whether or not the <code>Player.GameplayPaused</code> notification has been disabled by the developer]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
Should be parented to <code>ReflectionMetadataClasses</code>]==],
	...
	loaded = [==[Fires when the <code>VideoFrame.Video</code> is loaded]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	teleportpartyasync = [==[Teleports a group of <code>Player</code> to the same server of the place with the given <code>DataModel.PlaceId</code>, returning the <code>DataModel.JobId</code> of the server instance they were teleported to]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	getordereddatastore = [==[Get an <code>OrderedDataStore</code> given a name and optional scope]==],
	...
	event = [==[The event that is fired when <code>BindableEvent:Fire</code> is called]==],
	...
	isactivatedwithexclusivemouse = [==[Returns true if this plugin is currently active with an exclusive mouse, after having been activated via the <code>Plugin:Activate</code> function]==],
	...
	gettranslatorforplayer = [==[Returns a <code>Translator</code> to be used for translations using the locale data loaded]==],
	recenteruserheadcframe = [==[Recenters the <code>DataType.CFrame</code> of the VR headset to the current orientation of the headset worn by the user]==],
	...
	getplayers = [==[Returns a table of all presently connected <code>Player</code> objects]==],
	...
	alphamode = [==[Determines how the alpha channel of the <code>SurfaceAppearance.ColorMap</code> of a <code>SurfaceAppearance</code> is used]==],
	...
	getcharacterappearanceasync = [==[Returns a <code>Model</code> containing the assets which the player is wearing, excluding gear]==],
	enabled = [==[Whether <code>ProximityPrompt</code> are enabled, and therefore shown, in-game]==],
	...
	vipserverownerid = [==[The <code>Player.UserId</code> of the account who owns the VIP server]==],
	...
	localtransparencymodifier = [==[Determines a multiplier for <code>BasePart.Transparency</code> that is only visible to the local client]==],
	...
	clipsdescendants = [==[Determines if descendant <code>GuiObject</code> outside of the bounds of a parent GUI element should render]==],
	...
	geargenresetting = [==[Not functional. Historically described the gear permissions of the <code>Articles.Place</code> as set on the Roblox website]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
...
<p class="text-nowrap" style={{fontFamily: 'Merriweather', fontSize: '1.6em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	worldtoviewportpoint = [==[Returns the 2D screen location of a <code>DataType.Vector3</code> position in the world, but does not account for the GUI inset]==],
	...
	bodytypescale = [==[Determines the factor by which the shape of a Humanoid rig is interpolated from the standard R15 body shape (0) to a taller and more slender body type (1); when <code>Humanoid:ApplyDescription</code>, maps to the "BodyTypeScale" <code>NumberValue</code> within the HumanoidDescription]==],
...
![<a href="/assets/blt4aaa5534850ad583/GearType_Ranged.png">Ranged Attribute</a>]==],
	...
	getaccessories = [==[Returns an array of <code>Accessory</code> that the <code>Humanoid</code> parent is currently wearing]==],
	intensity = [==[Determines the opacity of the sun rays]==],
	triggerended = [==[Triggers when <code>ProximityPrompt.KeyboardKeyCode</code>/button is released, for longer events where the user is required to hold down the button]==],
	...
	flagstandservice = [==[An internal service responsible for handling the now deprecated <code>FlagStand</code> and <code>Flag</code> objects]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	datacomplexity = [==[The total amount of data currently being stored in the <code>Player</code> cache on the current place]==],
	...
	getmouselocation = [==[Returns the current screen location of the player's <code>Mouse</code> relative to the top left corner of the screen]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	reset = [==[Resets the current game to a waypoint set when <code>RunService:Run</code> was called]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	targetradius = [==[Determines the maximum distance from the <code>RocketPropulsion.Target</code> the part must be in order for <code>RocketPropulsion.ReachedTarget</code> to be fired]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	pants = [==[Displays a Pants texture from the Roblox website to display on a <code>Humanoid</code> rig]==],
	...
	motor6d = [==[Creates an animatable joint between two <code>BasePart</code>s]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	viewportframe = [==[<code>GuiObject</code> that can display children 3D objects]==],
	...
	cframe = [==[The <code>DataType.CFrame</code> of the <code>Camera</code>, defining its position and orientation in the 3D world]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	addaccessory = [==[Attaches the specified <code>Accessory</code> to the <code>Humanoid</code> parent]==],
	...
	region3int16 = [==[A Region3 stored as two boundaries as opposed to position and size components.]==],
	getkeyspressed = [==[Returns an array of <code>InputObject</code> associated with the <code>Enum.KeyCode</code> currently being pressed down]==],
	getplayerplaceinstanceasync = [==[Returns the <code>DataModel.PlaceId</code> and <code>DataMode.lJobId</code> of the server the user with the given <code>Player.UserId</code> is in provided it is in the same game as the current place]==],
	getkeyatindex = [==[Returns a copy of a key at a given index.]==],
	tweeninfo = [==[A container of parameters for <code>Tween</code>s.]==],
	...
	gamepassservice = [==[A service associated with the legacy game pass system. Use <code>MarketplaceService</code> for all new work]==],
	promptsetfavorite = [==[Prompts the <code>Players.LocalPlayer</code> to favorite or unfavorite the given asset or bundle]==],
	playing = [==[Indicates whether the <code>VideoFrame.Video</code> is currently playing. It can be set to start or pause playback]==],
	...
	setminutesaftermidnight = [==[Sets <code>Lighting.TimeOfDay</code> and <code>Lighting.ClockTime</code> to the given number of minutes after midnight]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	cleartextonfocus = [==[Determines whether clicking on the TextBox will clear its <code>TextBox.Text</code> property]==],
	...
	getapplieddescription = [==[Returns back a copy of the <code>Humanoid</code> cached <code>HumanoidDescription</code>, which describes its current look]==],
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as functions under the class this is parented to.]==],
	...
	died = [==[Fires when the <code>Humanoid</code> dies]==],
	...
	statechanged = [==[Fired when the state of the <code>Humanoid</code> is changed]==],
	...
	teleportasyncresult = [==[The return structure of the <code>TeleportAsync</code> function call]==],
	...
	volume = [==[Indicates how loud the <code>VideoFrame.Video</code> is currently playing back]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	timelength = [==[Indicates the length of the <code>VideoFrame.Video</code> in seconds]==],
...
It is available for developers to use, to a limited degree.]==],
	...
	bordercolor3 = [==[Determines the color of a <code>GuiObject</code> border]==],
	...
	privateserverownerid = [==[Describes the <code>Player.UserId</code> of the <code>Player</code> that owns the <code>Articles/Creating a VIP Server on Roblox|VIP server</code>, if the server is a VIP server]==],
	...
	cornerradius = [==[Determines the radius, in pixels, of the <code>UICorner</code> UIComponent]==],
...
<p class="text-nowrap" style={{fontFamily: 'Roboto Condensed', fontSize: '1.65em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	headlocked = [==[Toggles whether the <code>Camera</code> will automatically track the head motion of a player using a VR device]==],
	...
	isa = [==[Returns true if an <code>Instance</code>'s class matches or inherits from a given class]==],
...
The behavior of the sidechain depends on the `Sound` or `SoundGroup` linked to it.
	...
	fire = [==[Fires the <code>BindableEvent</code>, which fires the <code>BindableEvent.Event</code> event]==],
	...
	fieldofview = [==[Sets the angle of the <code>Camera</code> vertical field of view]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
Defaults to 32 MBs.
	...
	preloadasync = [==[Yields until all of the assets associated with the given <code>Instance</code> have loaded]==],
	...
	panunits = [==[Pans the <code>Camera</code> around the <code>Camera.Focus</code> in 45 degree increments around the Y axis]==],
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as events under the class this is parented to.]==],
	...
	arepartstouchingothers = [==[Returns true if any of the given <code>BasePart</code> are touching any other parts]==],
	findpathasync = [==[Finds a <code>Path</code> between the two provided points]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	minvalue = [==[The lowest number that the <code>DoubleConstrainedValue.Value</code> property can be]==],
	...
	animationcontroller = [==[An object which allows animations to be loaded and applied to a character or model in place of a <code>Humanoid</code> when a Humanoid is not needed]==],
...
<p class="text-nowrap" style={{fontFamily: 'Source Sans Pro', fontSize: '1.7em', fontWeight: 600, margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	screenorientation = [==[Sets the default <code>Enum.ScreenOrientation</code> for users with mobile devices]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	placeid = [==[Describes the ID of the <code>Articles.Place</code> running on the server]==],
	cframe = [==[A datatype that represents both a 3D position and orientation.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	angularvelocity = [==[A <code>DataType.Vector3</code> force applied to achieve and maintain an angular velocity for the body]==],
	...
	getlastinputtype = [==[Returns the <code>Enum.UserInputType</code> associated with the user’s most recent input]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	touchrotate = [==[Fires when a user rotates two fingers on a <code>UserInputService.TouchEnabled</code> device - such as the screen of a mobile device]==],
	...
	getemotes = [==[Returns a dictionary of emotes that have been <code>HumanoidDescription:AddEmote</code> or <code>HumanoidDescription:SetEmotes</code> to this description]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	insert = [==[Inserts <code>Instance</code> into Workspace]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as properties under the class this is parented to.]==],
	...
	getdeviceacceleration = [==[Returns an <code>InputObject</code> that describes the device's current acceleration]==],
	...
	getusercframe = [==[Returns a <code>DataType.CFrame</code> describing the position and orientation of a specified virtual reality device]==],
	...
	played = [==[Fires whenever the <code>VideoFrame.Video</code> is played using the <code>VideoFrame:Play</code> function or by setting <code>VideoFrame.Playing</code> to true]==],
	rotation = [==[The rotation of the part in degrees for the three axes]==],
	gettouchingparts = [==[Returns a table of all <code>BasePart.CanCollide</code> true parts that intersect with this part]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	rightarmcolor = [==[Determines the <code>BodyColors.RightArmColor3</code> of a Humanoid when applied]==],
...
See <code>Enum.PermissionLevelShown</code> for more info.]==],
	...
	limitsenabled = [==[Determines whether <code>RodConstraint.LimitAngle0</code> and <code>RodConstraint.LimitAngle1</code> control the angles between the rod and the respective attachments]==],
	...
	getgamepadstate = [==[Returns an array of <code>InputObject</code> for all available inputs on the given gamepad, representing each input’s last input state]==],
	gamepaddisconnected = [==[Fires when a gamepad is disconnected from the client. Passes the <code>Enum.UserInputType</code> of the gamepad that was disconnected]==],
	camerasubject = [==[The <code>Humanoid</code> or <code>BasePart</code> that is the <code>Camera</code> subject]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
<p class="text-nowrap" style={{fontFamily: 'Fredoka One', fontSize: '1.6em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	getpointcoordinates = [==[Returns a table of <code>Path</code> instances]==],
...
<p class="text-nowrap" style={{fontFamily: 'Grenze Gotisch', fontSize: '1.95em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	label = [==[The name of the navigation area inside or on top of the <code>Part</code> volume]==],
...
<img alt="Navigation Attribute" src="/assets/bltb4bbcb97611d3ab5/GearType_Navigation.png" />]==],
	...
	leftarmcolor = [==[Determines the <code>BodyColors.LeftArmColor3</code> of a <code>Humanoid</code> when applied]==],
...
This object cannot be created, but it can be retrieved from the <code>ScriptDebugger</code> class.]==],
	...
	invoke = [==[Calls the <code>BindableFunction.OnInvoke</code> callback of the <code>BindableFunction</code>, returning any values if there were any]==],
...
<p class="text-nowrap" style={{fontFamily: 'Source Sans Pro', fontSize: '1.7em', margin: '5px 0px'}}><i>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =</i>]==],
	...
	playerhaspass = [==[Returns <em>true</em> if the <code>Player</code> has the specified legacy game pass. Does not work with new game passes]==],
	...
	maxactivationdistance = [==[The maximum distance a Player’s <code>Player.Character</code> can be from the <code>ProximityPrompt</code> for the prompt to appear]==],
	...
	classname = [==[A read-only string representing the class this <code>Instance</code> belongs to]==],
	...
	cansetnetworkownership = [==[Checks whether you can set a <code>BasePart</code> network ownership]==],
	...
	backgroundcolor3 = [==[Determines a<code>GuiObject</code> background color]==],
...
starts.]==],
	...
	cylindermesh = [==[The CylinderMesh object applies a 'cylinder' mesh to the <code>BasePart</code> it is parented to]==],
	...
	lastinputtypechanged = [==[Fires when the client's <code>Enum.UserInputType</code> is changed]==],
...
<img alt="Voxel" src="/assets/blt87d45df6d6aacbdc/Technology.Voxel.jpg" />]==],
	...
	motor = [==[Acts the same as a Hinge, but has a grey ring around it and automatically rotates any part connected to it, however, using <code>HingeConstraint</code> to join parts is preferred]==],
	hinge = [==[Makes the side appear with a yellow hinge. Any part connected to this hinge will stick to the side and rotate using physics, however, using <code>HingeConstraint</code> to join parts is preferred]==],
	...
	textyalignment = [==[Determines the vertical alignment of rendered text.]==],
	touchswipe = [==[Fired when a user swipes their fingers on a <code>UserInputService.TouchEnabled</code> device - such as the screen of a mobile device]==],
	...
	part1 = [==[The first <code>BasePart</code> that the constraint connects]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	draggable = [==[Determines whether a <code>GuiObject</code> (and its descendants) can be dragged around the screen]==],
	y = [==[The Y axis]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	getguiobjectsatposition = [==[Returns a list of visible <code>GuiObject</code> occupying the given point on the screen]==],
	...
	linearsquare = [==[Volume attenuates between <code>Sound.EmitterSize</code> and <code>Sound.MaxDistance</code> with a linear squared relationship]==],
	...
	promptallowinventoryreadaccess = [==[Prompts the <code>Players.LocalPlayer</code> to allow the developer to read what items the user has in their inventory and other avatar editor related information]==],
	...
	setnavigationgamepad = [==[Sets whether or not the specified <code>Enum.UserInputType</code> can move the <code>GuiObject</code> navigator]==],
	...
	inversetapered = [==[Volume attenuates between <code>Sound.EmitterSize</code> and <code>Sound.MaxDistance</code> with a linear relationship]==],
	...
	isvibrationsupported = [==[Returns true if the specified <code>Enum.UserInputType</code> supports haptic feedback]==],
	...
	jumpheight = [==[Provides control over the force with which a <code>Humanoid</code> jumps]==],
	...
	folder = [==[A simple container used to hold and organize Roblox objects. Unlike other container classes like <code>Model</code>, it offers no additional functionality]==],
	...
	userinputservice = [==[The <code>UserInputService</code> is a service used to detect the type of input available on a user's device via the use of a <code>LocalScript</code>. The service is also used to detect input events]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	backgroundcolor = [==[Determines the color of a <code>GuiObject</code> background]==],
...
It's supposed to render a large XYZ axis in the center of each <code>BasePart</code>, but the axis rendering component doesn't work correctly.]==],
	...
	hoverimage = [==[A textureId that will be used when <code>ImageButton</code> is being hovered]==],
	widthscale = [==[Determines by what factor the width (left-to-right distance) of a <code>Humanoid</code> is scaled; when <code>Humanoid:ApplyDescription</code>, maps to the "BodyWidthScale" <code>NumberValue</code> within the Humanoid]==],
	...
	lighting = [==[Refers to the game's <code>Lighting</code> service]==],
	...
	visible = [==[Determines whether a <code>GuiObject.GUI</code> and its descendants will be rendered]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
<p class="text-nowrap" style={{fontFamily: 'Denk One', fontSize: '1.7em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	viewportpointtoray = [==[Creates a unit <code>DataType.Ray</code> from a position on the viewport (in pixels), at a given depth from the <code>Camera</code> orientated in the <code>Camera</code> direction. Does not account for the GUI inset]==],
	...
	teamchat = [==[Makes the <code>LocalPlayer</code> chat the given message, which will only be viewable by users on the same team]==],
...
<img alt="Social Attribute" src="/assets/bltd3ac42c4659a2371/GearType_Social.png" />]==],
	...
	changed = [==[Fired whenever the <code>NumberValue.Value</code> is changed]==],
...
<img alt="AlphaMode Transparency" src="/assets/bltd194e7f5a88d1fdd/fern-overlay.png" />]==],
	...
	axes = [==[Axes is a datatype used for the <code>ArcHandles</code> class to control what rotation axes are currently enabled]==],
...
<img alt="The Static TextureMode" src="/assets/blt4e6854cd4a39d272/Enum_TextureMode_Static.gif" />]==],
	findpartonraywithwhitelist = [==[Returns the first <code>BasePart</code> or <code>Terrain</code> cell intersecting with the given <code>DataType.Ray</code> that is in, or is a descendant of an object in, the given whitelist]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	setteleportgui = [==[Sets the custom <code>ScreenGui</code> that will be shown to the local user during teleportation, prior to the teleport being invoked]==],
...
<div><div><div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><pre class="prettyprint linenums lang-lua">LocalizationTable:RemoveEntry(key,"","")</pre></div></div></div>]==],
	...
	gameid = [==[Describes the ID of the <code>Articles/Multi Place Games|game</code> the <code>Articles.Place</code> running on the server belongs to]==],
	...
	tiltunits = [==[Tilts the <code>Camera</code> around its <code>Camera.Focus</code> in 10 degree increments around the <code>Camera</code> X axis]==],
	color = [==[Sets color used for the debug rendering. See <code>WrapTarget.DebugMode</code>]==],
...
Note: this property is set up automatically by the FBX importer]==],
	...
	nearplanez = [==[Describes the negative z-offset, in studs, of the <code>Camera</code> near clipping plane]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	bulkmoveto = [==[Moves a table of <code>Part</code> to <code>DataType.CFrame</code> in a table of CFrames, without firing property changed events]==],
	...
	gettranslatorforplayerasync = [==[Yields until the cloud localization asset for the player's locale has been loaded - if available. Returns a <code>Translator</code> to be used for translations using the locale data loaded]==],
	walkspeed = [==[Describes the <code>Humanoid</code> maximum movement speed in studs/sec]==],
	...
	getarrivingteleportgui = [==[Returns the <em>customLoadingScreen</em> the <code>Players.LocalPlayer</code> arrived into the place with]==],
	...
	attachment = [==[Defines a point and orientation relative to the parent <code>BasePart</code>, typically used with <code>Constraint</code>s]==],
	...
	resolution = [==[Gets the original source resolution of the <code>VideoFrame.Video</code> file]==],
	looped = [==[Sets whether or not the <code>VideoFrame.Video</code> repeats once it has finished when it is playing]==],
	videoframe = [==[A GUI object that renders a rectangle, like a <code>Frame</code> does, with a moving video image]==],
	...
	usercframechanged = [==[Fires when the <code>DataType.CFrame</code> of a specified Virtual Reality device changes]==],
	infocusradius = [==[Controls the distance away from the <code>DepthOfFieldEffect.FocusDistance</code> where no blur is applied]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	characterappearanceloaded = [==[Fires when the the full appearance of a <code>Player</code>'s <code>Player.Character</code> has been inserted]==],
	...
	touchpan = [==[Fired when a user drags at least one finger on a <code>UserInputService.TouchEnabled</code> device - such as the screen of an mobile device]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	touchesusecollisiongroups = [==[Determines whether <code>BasePart</code> in different groups set to not collide will ignore collisions and touch events]==],
...
<p class="text-nowrap" style={{fontFamily: 'Michroma', fontSize: '1.3em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	ismousebuttonpressed = [==[Returns whether the given <code>Enum.UserInputType</code> is currently held down]==],
	occludeall = [==[Occlude (hide) all humanoid names.]==],
	iskeydown = [==[Returns whether the given  <code>Enum.KeyCode</code> is currently held down]==],
	getmousedelta = [==[Returns the change, in pixels, of the position of the player’s <code>Mouse</code> in the last rendered frame. Only works if the mouse is locked]==],
	getgamepadconnected = [==[Returns whether a gamepad with the given <code>Enum.UserInputType</code>''gamepadNum'' is connected]==],
	gamepass = [==[GamePass format type - the product is a GamePass.]==],
	getfocusedtextbox = [==[Returns the currently <code>TextBox</code> the client is currently focused on]==],
	texture = [==[Determines the image rendered on particle billboards]==],
	getdevicegravity = [==[Returns an <code>InputObject</code> describing the device's current gravity vector]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
If set to <a href="/articles/String" title="String"><span>"Client"</span></a>, this member will not be available to auto fill when editing a `Script`.
	...
	trusspart = [==[Truss parts are the same as <code>Part</code>, except that they have a different visual style, resize differently and characters are able to climb them]==],
...
<img alt="Building Attribute" src="/assets/blte36164ad978dbc99/GearType_Building.png" />]==],
	...
	promptsaveavatarcompleted = [==[Fires when the <code>AvatarEditorService:PromptSaveAvatar</code> operation is completed]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
The value of this string should be full paths to each directory, separated only by semicolons (<code>;</code>)
	...
	getjoindata = [==[Returns a dictionary containing information on how the <code>Player</code> joined the game]==],
...
If this is called inside of a script running inside of the TestService, this will initiate a <a href="/articles/Lua-debugger" class="mw-redirect" title="Lua Debugger">breakpoint</a> on the line that invoked the error.
	...
	teleporttospawnbyname = [==[A variant of <code>TeleportService:Teleport</code> that causes the <code>Player</code> to spawn at a <code>SpawnLocation</code> of the given name at the destination place]==],
	rightbrowlowerer = [==[Lowers the right brow down]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	getteleportsetting = [==[Retrieves a teleport setting saved using <code>TeleportService:SetTeleportSetting</code> using the given key]==],
	getlocalplayerteleportdata = [==[Returns the <em>teleportData</em> the <code>Players.LocalPlayer</code> arrived into the place with]==],
...
Note: this property is set up automatically by the FBX importer]==],
	...
	getuseridfromnameasync = [==[Sends a query to the Roblox website for the <code>Player.UserId</code> of an account with a given username]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	isedit = [==[Returns whether the current environment is in <code>Edit</code> mode]==],
	...
	textwrapped = [==[Determines if text wraps to multiple lines within the <code>TextButton</code> element space, truncating excess text]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	changed = [==[Fired whenever the <code>DoubleConstrainedValue.Value</code> of the <code>DoubleConstrainedValue</code> is changed]==],
...
If this value is high, then it means the game instance is under stress from the physics simulations taking place.]==],
	...
	idleanimation = [==[When this description is <code>Humanoid:ApplyDescription</code> to a <code>Humanoid</code>, this determines the <code>Animation.AnimationId</code> to play when its <code>Humanoid:GetState</code> is <code>enum.HumanoidStateType</code> at a speed near zero]==],
	removekeyatindex = [==[Removes a given number of Keys starting from a given index. Returns the number of keys that were removed.]==],
	...
	volume = [==[The volume of the <code>Sound</code>. Can be set between 0 and 10. Defaults to 0.5]==],
...
<p class="text-nowrap" style={{fontFamily: 'Luckiest Guy', fontSize: '1.6em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	serverinstanceid = [==[The <code>DataModel.JobId</code> of the server instance to teleport to]==],
	...
	getrendercframe = [==[Returns the actual <code>DataType.CFrame</code>where the <code>Camera</code> is being rendered, accounting for any roll applied and the impact of VR devices]==],
...
<code>ReflectionMetadataMember</code>s that are parented to this object will be perceived as callbacks under the class this is parented to.]==],
	...
	workspace = [==[A reference to the <code>Workspace</code> service]==],
...
<p class="text-nowrap" style={{fontFamily: 'Sarpanch', fontSize: '1.65em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	packagelink = [==[Links a <code>DataModel</code> instance to a corresponding asset in the cloud]==],
	...
	seated = [==[Fired when a <code>Humanoid</code> either sits in a <code>Seat</code> or <code>VehicleSeat</code> or gets up]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	reflectionmetadataenum = [==[Registers information about an <code>Enum</code> and its EnumItems]==],
	...
	prompttriggerended = [==[Triggers when the player stops holding down the <code>ProximityPrompt.KeyboardKeyCode</code>/button while triggering a prompt]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	changed = [==[Fired whenever the <code>ObjectValue.Value</code> is changed]==],
	...
	inverse = [==[Volume attenuates from <code>Sound.EmitterSize</code> in an inverse manner]==],
...
<li><code>PluginMenu:ShowAsync</code>, shows the menu at the mouse cursor. Yields until either an item is selected or the menu is closed. The selected action fires its Triggered event</li>
	...
	promptcreateoutfit = [==[Prompts the <code>Players.LocalPlayer</code> to save the given <code>HumanoidDescription</code> as an outfit]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	allowbinding = [==[Whether the <code>PluginAction</code> will be hidden from Studio's shortcuts view]==],
	currentscreenorientation = [==[Describes the user's current screen orientation.]==],
	unloading = [==[Fires immediately before the <code>Plugin</code> stops running]==],
	...
	isactivated = [==[Returns true if this plugin is currently active, after having been activated via the <code>Plugin:Activate</code> function]==],
	distanceupperlimit = [==[Determines the distance in studs that a <code>BillboardGui</code> will stop scaling smaller in size at]==],
	...
	robloxlocked = [==[A deprecated property that used to protect <code>CoreGui</code> objects]==],
...
<p class="text-nowrap" style={{fontFamily: 'Fondamento', fontSize: '1.75em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	getfriendsasync = [==[Returns a <code>FriendPages</code> object which contains information for all of the given player's friends]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
<img alt="Melee Attribute" src="/assets/bltb08afda60a136e61/GearType_Melee.png" />]==],
	...
	teleportoptions = [==[Optional input arguments to the <code>TeleportService:TeleportAsync</code> function]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	setcoreguienabled = [==[Sets whether the <code>CoreGui</code> element associated with the given <code>Enum.CoreGuiType</code> is enabled or disabled]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
<p class="text-nowrap" style={{fontFamily: 'Indie Flower', fontSize: '1.85em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	torsocolor = [==[Determines the <code>BodyColors.TorsoColor3</code> of a Humanoid when applied]==],
	...
	getplayerbyuserid = [==[Returns the <code>Player</code> with the given <code>Player.UserId</code> if they are in-game]==],
...
This will not return anything if <a href="/api-reference/function/HapticService/SetMotor" class="mw-redirect" title="SetMotor">SetMotor</a> has not been called prior.
	...
	findpartonraywithignorelist = [==[Returns the first <code>BasePart</code> or <code>Terrain</code> cell intersecting with the given <code>DataType.Ray</code> that isn't in, nor is a descendant of an object in, the given ignore list]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	removemarker = [==[Removes a <code>KeyframeMarker</code> from the <code>Keyframe</code>by settings its <code>Instance.Parent</code> to nil]==],
...
<img alt="ShadowMap" src="/assets/blt5d79df0c0af20ab8/Technology.ShadowMap.jpg" />]==],
	...
	currentcamera = [==[<code>Camera</code> that is used to render children objects]==],
	...
	computeasync = [==[Computes a <code>Path</code> from a start position to an end position]==],
	...
	headscale = [==[Determines by what factor the Head of a <code>Humanoid</code> is scaled; when <code>Humanoid:ApplyDescription</code>, maps to the "HeadScale" <code>NumberValue</code> within the Humanoid]==],
	...
	fallenpartsdestroyheight = [==[Determines the height at which falling <code>BasePart</code> (and their ancestor <code>Model</code>) are destroyed]==],
	...
	teamcolor = [==[The <code>Team</code> this flag is for. Corresponds with the TeamColors in the <code>Teams</code> service]==],
	...
	relativeto = [==[The <code>DataType.CFrame</code> in which the force is expressed]==],
...
<p class="text-nowrap" style={{fontFamily: 'Source Sans Pro', fontSize: '1.7em', fontWeight: 300, margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	changed = [==[Fired when <code>RayValue.Value</code> is changed]==],
	...
	unitray = [==[A <code>DataType.Ray</code> directed towards the <code>Mouse</code>'s world position, originating from the <code>Workspace.CurrentCamera</code>'s world position]==],
	targetsurface = [==[Indicates the <code>Enum.NormalId</code> of the <code>BasePart</code> surface at which the mouse is pointing]==],
	subscribeasync = [==[Begins listening to the given topic]==],
	hit = [==[The <code>DataType.CFrame</code> of the mouse's position in 3D space]==],
	...
	getfavorite = [==[Returns if the <code>Players.LocalPlayer</code> has favorited the given bundle or asset]==],
	...
	maxvalue = [==[The highest number that the <code>DoubleConstrainedValue.Value</code> property can be]==],
...
<img alt="Power Up Attribute" src="/assets/blt0c97538d414a753b/GearType_PowerUp.png" />]==],
	...
	cameratype = [==[Specifies the <code>Enum.CameraType</code> to be read by the camera scripts]==],
	width = [==[The width of the Rect.]==],
	bodymover = [==[Base class for objects that continually exert forces to parts]==],
	imagecolor3 = [==[Determines how a rendered image will be colorized.]==],
	promptgameinvite = [==[Prompts the given <code>Player</code> with the game invite screen]==],
	...
	bevelmesh = [==[An abstract class that <code>BlockMesh</code> and <code>CylinderMesh</code> inherit from]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	mousehoverenter = [==[Fired when the <code>ClickDetector</code>'s parent is hovered upon by a player]==],
	...
	transform = [==[Describes the current animation offset of the <code>Motor6D</code> joint]==],
	...
	getdevicerotation = [==[Returns an <code>InputObject</code> and a <code>DataType.CFrame</code>,describing the device's current rotation vector]==],
	...
	mouseiconenabled = [==[Determines whether the <code>Mouse</code> icon is visible]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	getplayerfromcharacter = [==[Returns the <code>Player</code> whose <code>Player.Character</code> matches the given instance, or <code>nil</code> if one cannot be found]==],
	...
	keyframemarker = [==[An instance meant to represent an event that will eventually be fired when a <code>Keyframe</code> is hit]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	getmarkers = [==[Returns an array containing all <code>KeyframeMarkers</code> that have been added to the <code>Keyframe</code>]==],
	addmarker = [==[Adds a <code>KeyframeMarker</code> to the <code>Keyframe</code> by parenting it to the keyframe]==],
...
<img alt="AlphaMode OverLay" src="/assets/blt625b6777e66ae841/fern-cutout.png" />]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	showdevelopmentgui = [==[Determines whether the contents of <code>StarterGui</code> is visible in studio]==],
	...
	limitangle1 = [==[Determines the maximum angle between the rod and <code>Constraint.Attachment0</code> when <code>RodConstraint.LimitsEnabled</code> is true]==],
	getsupportedgamepadkeycodes = [==[Returns an array of <code>Enum.KeyCode</code> that the gamepad associated with the given <code>Enum.UserInputType</code> supports]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	oninvoke = [==[Callback for when the <code>BindableEvent</code> is invoked]==],
	...
	makejoints = [==[Goes through all <code>BasePart</code>s in the <code>Model</code>. If any part's side has a SurfaceType that can make a joint it will create a joint with any adjacent parts]==],
	...
	pressedimage = [==[A textureId that will be used when an <code>ImageButton</code> is being pressed]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
...
<img alt="Musical Attribute" src="/assets/bltfc24574f48eb2125/GearType_Musical.png" />]==],
	rightlegcolor = [==[Determines the <code>BodyColors.RightLegColor3</code> of a Humanoid when applied]==],
	leftlegcolor = [==[Determines the <code>BodyColors.LeftLegColor3</code> of a <code>Humanoid</code> when applied]==],
	fromrgb = [==[Returns a Color3 from the given components within the range [0, 255].]==],
	heightscale = [==[Determines by what factor the height (top-to-bottom distance) of a Humanoid rig is scaled; when <code>Humanoid:ApplyDescription</code>, maps to the "HeightScale" <code>NumberValue</code> within the Humanoid]==],
	swimming = [==[Fires when the speed at which a <code>Humanoid</code> is swimming in <code>Terrain</code> water changes]==],
	...
	processuserinput = [==[Allows the StarterGui service to process input like <code>PlayerGui</code> and <code>CoreGui</code> do]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	sizeconstraint = [==[Selects the <code>GuiObject.Size</code> axes that a <code>GuiObject</code> will be based relative to the size of its parent]==],
	replacebodypartr15 = [==[Dynamically replaces a Humanoid body part with a different part.]==],
	default = [==[The default prompt UI style]==],
	moveto = [==[Causes the <code>Humanoid</code> to attempt to walk to the given location by setting the <code>Humanoid.WalkToPoint</code> and <code>Humanoid.WalkToPart</code> properties]==],
	...
	breakjointsondeath = [==[Determines whether a <code>Humanoid</code> joints break when in the Dead state]==],
...
This is the only guaranteed way to verify if the user is on a console or not.
	...
	buildrigfromattachments = [==[Assembles a tree of <code>Motor6D</code> joints by attaching together <code>Attachment</code> objects in a <code>Humanoid</code> character]==],
	...
	zindex = [==[Determines the order in which a <code>GuiObject</code> renders relative to other GUIs]==],
	...
	nextselectionright = [==[Sets the <code>GuiObject</code> which will be selected when the `Enum/Gamepad selector is moved in this direction]==],
	bordercolor = [==[Determines the color of a <code>GuiObject</code> border]==],
	applylayout = [==[Force re-layout of subling UI elements.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	filemesh = [==[The mesh is determined by the Roblox mesh asset id provided.]==],
	backgroundtransparency = [==[Determines the transparency of the <code>GuiObject</code> background and border]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
...
<p class="text-nowrap" style={{fontFamily: 'Kalam', fontSize: '1.75em', margin: '5px 0px'}}>The quick brown fox jumps over the lazy dog.<br />0123456789 , : ! ? # % & ( ) - + =]==],
	...
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	udim = [==[A one-dimensional value with two components, a relative scale and an absolute offset.]==],
	removeaccessories = [==[Removes all <code>Accessory</code> worn by the <code>Humanoid</code> parent]==],
	...
	creatortype = [==[Describes the <code>Enum.CreatorType</code> of the <code>Articles.Place</code>, whether the place is owned by a user or a group]==],
	...
	rect = [==[A value that represents a two-dimensional rectangle.]==],
	getbinarycontents = [==[Reads the contents of the <code>File</code> as a string]==],
	...
	running = [==[Fires when the speed at which a <code>Humanoid</code> is running changes]==],
	...
	maxitems = [==[Historically the maximum number of items that can be assigned to the <code>Debris</code> service at one time]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	reflectionmetadataenums = [==[Acts as a <code>Folder</code> for <code>ReflectionMetadataEnum</code> objects]==],
	...
	setcamerapanmode = [==[Sets the <code>Enum.CameraPanMode</code> to be used by the <code>Camera</code> on mobile devices]==],
...
<code>BasePart</code> <em>ParamA</em> will determine the maximum speed at which the part will spin, and BasePart <em>ParamB</em> will determine how frequently it changes direction.]==],
	...
	placeversion = [==[Describes the version of the <code>Articles.Place</code> the server is running on]==],
	textureid = [==[The texture applied to the <code>MeshPart</code>.]==],
	genre = [==[Not functional. Historically described the <code>Enum.Genre</code> of the <code>Articles.Place</code> as set on the Roblox website]==],
	shirt = [==[Displays a Shirt texture from the Roblox website to display on a <code>Humanoid</code> rig]==],
	...
	move = [==[Causes the <code>Humanoid</code> to walk in the given direction]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	requiresneck = [==[Allows developers to disable the behavior where a player <code>Character</code> dies if the Neck <code>Motor6D</code> is removed or disconnected even momentarily]==],
	...
	targetoffset = [==[Determines the world offset from the <code>RocketPropulsion.Target</code> toward which the force/torque is exerted]==],
	bindactivate = [==[Bind a <code>Enum.KeyCode</code> with a specific <code>Enum.UserInputType</code> to trigger <code>Tool.Activation</code> and <code>ClickDetector</code> events]==],
	...
	climbing = [==[Fires when the speed at which a <code>Humanoid</code> is climbing changes]==],
	...
	platform = [==[Historically a form of <code>Seat</code> that wouldn't place the player in a sitting pose. This object is no longer create-able and cannot be used by developers]==],
	...
	limitangle0 = [==[Determines the maximum angle between the rod and <code>Constraint.Attachment0</code> when <code>RodConstraint.LimitsEnabled</code> is true]==],
	...
	unionasync = [==[Performs a Union operation on the calling <code>BasePart</code> and the list of parts passed in as the first parameter]==],
	...
	drylevel = [==[The output volume of the original sound.]==],
	loadasset = [==[Returns a <code>Model</code> containing the asset]==],
...
This item should be used in a <code>LocalScript</code> in order to work as expected online.]==],
	...
	bordersizepixel = [==[Determines the pixel width of a <code>GuiObject</code> border]==],
	...
	mousehoverleave = [==[Fired when a player's mouse moves off of the <code>ClickDetector</code>'s parent]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	getavailablethemes = [==[Returns a list of <code>StudioTheme</code> available in Studio]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	jumppower = [==[Determines how much upwards force is applied to the <code>Humanoid</code> when jumping]==],
	...
	collisiontype = [==[Selects the <code>Enum.HumanoidCollisionType</code> for R15 and Rthro non-player characters]==],
	...
	touchtapinworld = [==[Fires when a user taps the game world on a <code>UserInputService.TouchEnabled</code> device - such as the screen of a mobile device]==],
	getnavigationgamepads = [==[Returns an array of <code>Enum.UserInputType</code> connected and enabled for GUI navigation in descending order of priority]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	worldtoscreenpoint = [==[Returns the 2D screen location of a <code>DataType.Vector3</code> position in the world, the depth of it from the screen and whether it is visible. Accounts for the GUI inset]==],
	...
	bindtoclose = [==[Binds a function to the <code>PluginGui</code> close button, overriding the default behavior]==],
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	...
	automaticcanvassize = [==[Determines whether <code>ScrollingFrame.CanvasSize</code> is resized based on child content]==],
	paused = [==[This event fires whenever the <code>VideoFrame.Video</code> is paused using <code>VideoFrame:Pause</code> or by setting <code>VideoFrame.Playing</code> to false]==],
	...
	getattributes = [==[Returns a dictionary of string → variant pairs for each of the <code>Instance</code> attributes]==],
...
<img alt="Transport Attribute" src="/assets/blt669c2a184782cd46/GearType_Transport.png" />]==],
	...
	connect = [==[Connects the given function to the event and returns an RBXScriptConnection that represents it.]==],
	screenpointtoray = [==[Creates a unit <code>DataType.Ray</code> from a position on the screen (in pixels), at a set depth from the <code>Camera</code> orientated in the <code>Camera</code> direction. Accounts for the GUI inset]==],
	...
	triggered = [==[Triggered when the prompt <code>ProximityPrompt.KeyboardKeyCode</code>/button is pressed, or after a specified amount of time holding the button, if <code>ProximityPrompt.HoldDuration</code> is used]==],
	wait = [==[Yields the current thread until the signal is fired and returns the parameters provided by the signal.]==],
	...
	loadanimation = [==[Loads an <code>Animation</code> onto a <code>Humanoid</code>, returning an <code>AnimationTrack</code> that can be used for playback]==],
	...
	vector2int16 = [==[A Vector2 with signed 16-bit integers for components.]==],
	flagstand = [==[The FlagStand and <code>Flag</code> are deprecated objects that were used to make capture the flag games]==],
